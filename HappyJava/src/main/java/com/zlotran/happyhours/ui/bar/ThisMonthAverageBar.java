...
public class ThisMonthAverageBar extends RefreshableBar {
    ...
    private static final String DEFAULT_LABEL_PREFIX = "This month average:\t";

    public ThisMonthAverageBar(int frameHeight, int frameWidth, LabelRefresher labelRefresher) {
        super(FROM, TO, labelRefresher);
        this.setBounds(frameWidth - (40 + DEFAULT_BAR_WIDTH), (2 * (frameHeight / 3)) - (DEFAULT_BAR_HEIGHT / 2) - ((frameHeight / 3) / 2), DEFAULT_BAR_WIDTH,
            DEFAULT_BAR_HEIGHT);
