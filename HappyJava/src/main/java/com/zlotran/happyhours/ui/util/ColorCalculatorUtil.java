...
public class ColorCalculatorUtil {
    ...
    public static Color calcColor(int barProgress, int peakYellow, int minBarProgress, int maxBarProgress) {
        ...
        if (barProgress < peakYellow) {
            color = new Color(255, (int) (((barProgress - minBarProgress) / ((double)peakYellow - minBarProgress)) * (255 - 50)), 0);
        } else if (barProgress <= maxBarProgress) {
            color = new Color(255 - (int) (((barProgress - (double)peakYellow) / (maxBarProgress - (double)peakYellow)) * 255), 255 - 50, 0);
        } else {
